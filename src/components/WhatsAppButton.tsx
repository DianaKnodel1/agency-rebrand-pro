...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-medium text-white shadow-lg shadow-black/20 transition-transform hover:scale-105 hover:bg-[#1EBE5D] focus:outline-none focus:ring-2 focus:ring-[#25D366]/40"
    >
      <svg
